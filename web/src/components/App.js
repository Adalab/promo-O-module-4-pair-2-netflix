...
const App = () => {
	...
	/*
  useEffect: obtener las películas del API. PARA PINTARLAS EN EL LISTADO
  ...
  */
	...
	/*
  useEffect: obtener el perfil de la usuaria. PARA PINTAR LA PAGINA DE PERFIL
  ...
  */
	...
	/*
  useEffect: obtener las películas de la usuaria. PARA PINTAR EL LISTADO DE FAVORITOS DE LA USUARIA.
  Se ejecuta cuando userId cambian de valor, es decir, cuando pasa de un string vacío a un strin relleno con el id de la usuaria.
